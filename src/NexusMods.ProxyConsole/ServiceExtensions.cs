...
{
    /// <summary>
    /// Adds a <see cref="RenderableDefinition"/> to the service collection, defining how to render the given type.
    ...
    /// <summary>
    /// Adds a <see cref="RenderableDefinition"/> to the service collection for the built-in renderable types.
    /// </summary>
    /// <param name="services"></param>
    /// <returns></returns>
